...
$this->title = 'Busqueda Patrocinador Natural';
...
<!-- FIN DE CEDULA -->
 ...
 <!-- Boton para aplicar la actualizacion -->
                                    ...
                                    <div class="col-sm-3" >
                                            ...
                                            <?= Html::a('Return',['/menu/menu-vertical'], ['class' => 'btn btn-primary','style' => 'height:30px;width:100px;margin-left:30px;' ]) //boton para volver al menu de seleccion tipo usuario ?>
