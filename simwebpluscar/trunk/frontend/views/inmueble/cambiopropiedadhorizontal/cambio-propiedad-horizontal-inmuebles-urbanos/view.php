...
<div class="inmuebles-view">
    ...
    <p>
       <?= Html::a(Yii::t('backend', 'Horizontal property change'), ['inmueble/cambiopropiedadhorizontal/cambio-propiedad-horizontal-inmuebles-urbanos/cambio-a-propiedad-horizontal-inmuebles'], ['class' => 'btn btn-primary']) ?>
