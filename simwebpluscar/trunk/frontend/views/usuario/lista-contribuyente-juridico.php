...
$this->title = Yii::t('frontend','Result of the Consult '.BuscarGeneralForm::getCedulaRif(1, $naturaleza, $cedula, $tipo));
                ...
                [
                    ...
                    'buttons' => [
                        'ok' => function ($url, $model, $key) {
                            if ($model->inactivo == 0 ) {
                                return Html::a('<center><span class= "fa fa-thumbs-up"></span></center>',['mostrar-pregunta-seguridad-juridico','id' => $key]);
                            } else {
