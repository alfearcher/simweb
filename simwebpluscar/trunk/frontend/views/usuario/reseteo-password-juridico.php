		...
		<div class="panel panel-primary">
			...
			<div class="panel-body" >
                           ...
                           <div class="row">
							...
							<div class="col-sm-3" >
                            <?= Html::a('Return',['/usuario/cambiar-password-contribuyente/cambiar-password-juridico'], ['class' => 'btn btn-primary','style' => 'height:30px;width:140px;margin-left:-40px;' ]) //boton para volver a la busqueda de pregunta de seguridad ?>
                            </div>
                            </div>
