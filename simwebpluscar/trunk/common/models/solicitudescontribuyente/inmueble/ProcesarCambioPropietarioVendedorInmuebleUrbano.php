 ...
 */
     ...
     */
    class ProcesarCambioPropietarioVendedorInmuebleUrbano extends SlInmueblesUrbanosSearch
    {
        private $_model;
        ...
        */
        ...
        {
            $result = false;
            $modelCambioPropietarioV = self::findActualizacionInmuebleUrbano();
         ...
         * en caso contrario.
         */
        private function updateSolicitudCambioPopietarioVendedor($modelNumeroCatastral)
        { 
            $result = false;
