...
class InscripcionInmueblesUrbanosForm extends Model{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['id_contribuyente','id_sim','parcela_catastro','casa_edf_qta_dom','piso_nivel_no_dom','apto_dom','medidor','tlf_hab', 'ano_inicio', 'manzana_limite', 'inactivo', 'tipo_ejido', 'propiedad_horizontal', 'estado_catastro', 'municipio_catastro', 'parroquia_catastro','ambito_catastro', 'sector_catastro', 'manzana_catastro', 'direccion'], 'required','message' => Yii::t('backend', 'Required field')],
