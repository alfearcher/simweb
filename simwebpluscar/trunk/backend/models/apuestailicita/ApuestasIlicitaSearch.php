 ...
 */
 ...
 /**	
 *	@file ApuestasIlicitaSearch.php
 *	
 *	@author Ronny Jose Simosa Montoya
 * 
 *	@date 17-09-2015
 * 
 *      @class ApuestasIlicitaSearch
...
/**
 * ApuestasIlicitaSearch represents the model behind the search form about `backend\models\apuestailicita\ApuestasIlicitaForm`.
 */
class ApuestasIlicitaSearch extends ApuestasIlicitaForm
{
    ...
    */
    ...
    /**
    *   Metodo search(), la consulta principal de las apuestas ilicitas al controllers.
    ...
    */
    ...
    {
            $query = ApuestasIlicitaForm::find();
