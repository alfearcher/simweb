...
namespace backend\models\apuestailicita;
error_reporting(0);
...
{   
    ...
    */
    ...
    { 
        return [
            ...
            //[ [ 'monto_apuesta'  ], 'required', 'when'=>function($operacion){ return $operacion->clase_apuesta != 0;} ],
            [ [ 'id_impuesto' ], 'integer' ],
    ...
    */
    ...
    {
        return [
                    'id_impuesto' => Yii::t( 'backend', 'id_tax' ),
                    'clase_apuesta' => Yii::t( 'backend', 'clase_apuesta' ),
                    'tipo_apuesta' => Yii::t( 'backend', 'tipo_apuesta' ),
                    'fecha_desde' => Yii::t( 'backend', 'fecha_desde' ),
                    'fecha_hasta' => Yii::t( 'backend', 'fecha_hasta' ),
                    'ano_impositivo' => Yii::t( 'backend', 'ano_impositivo' ),
                    'monto_apuesta' => Yii::t( 'backend', 'monto' ),
                    'porcentaje' => Yii::t( 'backend', 'porcentaje' ),
            'fecha_comprobar' => Yii::t( 'backend', 'ddd' ),
        ];
    }
