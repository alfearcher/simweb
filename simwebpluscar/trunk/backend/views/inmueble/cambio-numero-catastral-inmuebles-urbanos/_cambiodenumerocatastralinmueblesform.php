                ...
                <table class="table table-striped ">
                    <tr>
                        <td colspan="5"> 
                            ...
                            <div class="col-lg-2"> 
                            <?= $form->field($model, 'catastro')->textInput(['disabled'=>$disabled,'style' => 'width:80px;']) ?>
                            </div> 
...
<!-- Direccion de Catastro  -->         
                   <tr>
                        <td  colspan="6">
                            ...
                            <div class="col-lg-1">
                            <?= $form->field($model, 'estado_catastro')->textInput(['style' => 'width:100px;'])->label(false);?> 
                            </div>
                            ...
                            <div class="col-lg-1">
                            <?= $form->field($model, 'municipio_catastro')->textInput(['style' => 'width:100px;'])->label(false); ?>
                            </div>
                            ...
                            <div class="col-lg-1">
                            <?= $form->field($model, 'parroquia_catastro')->textInput(['style' => 'width:100px;'])->label(false) ?>
                            </div> 
                            ...
                            <div class="col-lg-1">
                            <?= $form->field($model, 'ambito_catastro')->textInput(['style' => 'width:100px;'])->label(false) ?>
                            </div> 
                            ...
                            <div class="col-lg-1">
                            <?= $form->field($model, 'sector_catastro')->textInput(['style' => 'width:100px;'])->label(false) ?>
                            </div> 
                            ...
                            <div class="col-lg-1">
                            <?= $form->field($model, 'manzana_catastro')->textInput(['style' => 'width:100px;'])->label(false) ?>
                            </div> 
