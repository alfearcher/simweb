		  ...
		  SideNav::widget([
		    ...
		    'items' => [
		        ...
		        ['label' => Icon::show('fa fa-book',['class' => $typeLong], $typeIcon) . '&nbsp; Registros Maestros',
		        	'items' => [
		        			['label' => 'Registros Datos Básicos', 'url' => '#', 'options' => ['value' => '520', 'id' => '500']],
		        ...
		        ['label' => Icon::show('fa fa-laptop',['class' => $typeLong], $typeIcon) . '&nbsp; Solicitudes',
		        	'items' => [
		        		...
		        		['label' => Icon::show('fa fa-home',['class' => $typeLong], $typeIcon) . '&nbsp; Inmuebles Urbanos', 
		        			'items' => [
		        						['label' => 'Inscripción de Inmuebles Urbanos', 'url' => '#'],
		        						...
		        						['label' => 'Cambio de Otros Datos del Inmueble', 'url' => '#'],
		        		...
		        		['label' => Icon::show('fa fa-car',['class' => $typeLong], $typeIcon) . '&nbsp; Vehiculos', 
		        			'items' => [
		        						['label' => 'Inscripción de Vehiculos', 'url' => '#'],
		        						['label' => 'Calcomania', 'url' => '#'],
		        						['label' => 'Solvencia', 'url' => '#'],
		        						['label' => 'Cambio de Propietario', 'url' => '#'],
		        						['label' => 'Cambio de Placa', 'url' => '#'],
		        						['label' => 'Desincorporación de Vehiculo', 'url' => '#'],
		        						['label' => 'Cambio de Otros Datos del Vehiculo', 'url' => '#'],
		        			]
		        		],
