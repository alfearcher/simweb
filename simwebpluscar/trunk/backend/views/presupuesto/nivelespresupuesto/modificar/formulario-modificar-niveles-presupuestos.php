 ...
 <!-- Boton para aplicar la actualizacion -->
                                    <div class="col-sm-4" >
                                       ...
                                       <div class="col-sm-2" >
                                            ...
                                            <?= Html::a('Return',['site/menu-vertical'], ['class' => 'btn btn-primary','style' => 'height:30px;width:100px;margin-left:50px;' ]) //boton para volver al menu de seleccion tipo usuario ?>
