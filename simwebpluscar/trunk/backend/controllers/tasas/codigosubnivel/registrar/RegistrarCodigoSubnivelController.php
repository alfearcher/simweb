 ...
 */
 ...
 /**    
 *  @file RegistrarCodigoSubnivelController.php
 *  
 *  @author Manuel Alejandro Zapata Canelon
 * 
 *  @date 15/10/16
 * 
 *  @class RegistrarCodigoSubnivelController
...
namespace backend\controllers\tasas\codigosubnivel\registrar;
...
class RegistrarCodigoSubnivelController extends Controller
{
  ...
  */
  public function actionRegistroCodigoSubnivel()
  { 
    

      $model = new RegistrarCodigoSubnivelForm();
            ...
            return $this->render('/tasas/codigosubnivel/registrar/formulario-registro-codigo-subnivel', [
                                                          'model' => $model,
