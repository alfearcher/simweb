 ...
 *	@date 19-09-2015
 *
 *  @class SolicitudViewCambioPropietarioVehiculoController
 *	@brief Clase
 *
 *
 *	@property
 ...
 */
 	...
 	namespace backend\controllers\vehiculo\solicitud\cambiopropietario;
	 ...
	 */
	class SolicitudViewCambioPropietarioVehiculoController extends Controller
	{
		...
		public function actionInicioView()
		{
			if ( isset($this->model) && isset($_SESSION['idContribuyente']) ) {
				...
				if ( $this->model->tipo_solicitud == 35 ) {

					return self::actionMostarSolicitudCambioPropietarioVehiculo();
		 ...
		 */
		private function actionMostarSolicitudCambioPropietarioVehiculo()
		{
			if ( $this->model->nivel_aprobacion == 2 ) {
					...
					return $this->render('/vehiculo/solicitudes/inscripcion/view-solicitud-cambio-propietario', [
