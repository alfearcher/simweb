...
<table repeat_header="1" cellpadding="1" cellspacing="1" width="100%" border="0">
	...
	<tr>
		...
		<th class="label-contribuyente" colspan="2"><?=Html::encode('CAPITAL'); ?></th>
	</tr>
	<tr class="cuerpo">
		...
		<td class="info-contribuyente" colspan="2"><?=Html::encode(Yii::$app->formatter->asDecimal($datosContribuyente['capital'], 2)); ?></td>
	</tr>
