...
<table repeat_header="1" cellpadding="1" cellspacing="1" width="100%" border="0">
	<caption>IDENTIFICACION Y VIGENCIA DE LA SOLVENCIA</caption>

	<tr>
		<th class="label-contribuyente" colspan="4"><?=Html::encode('ID CONTRIBUYENTE'); ?></th>
		<th class="label-contribuyente" colspan="3"><?=Html::encode('FECHA EMISION'); ?></th>
		<th class="label-contribuyente" colspan="3"><?=Html::encode('FECHA VENCIMIENTO'); ?></th>
	</tr>
	<tr class="cuerpo">
