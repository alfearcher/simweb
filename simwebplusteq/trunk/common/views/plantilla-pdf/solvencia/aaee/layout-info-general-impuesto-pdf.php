 ...
 *  @date 27-11-2016
 *
 *  @view layout-info-general-impuesto-pdf.php
 *
 *
 *  @property
 *
...
<table repeat_header="1" cellpadding="1" cellspacing="1" width="100%" border="0">
	...
	<tr>
		...
		<th class="label-contribuyente" colspan="7"><?=Html::encode('Nro. LICENCIA'); ?></th>
	...
	<tr class="cuerpo">
		...
		<td class="info-contribuyente" colspan="7"><?=Html::encode($datosContribuyente['licencia']); ?></td>
