 ...
 */
 ...
 /**
 *  @file SlAnulacionesPatrocinadores.php
 *
 *  @author Manuel Alejandro Zapata Canelon
 *
 *  @date 07/09/2016
 *
 *  @class SlAnulacionesPatrocinadores
 *  @brief Modelo que instancia la conexion a la base de datos para buscar datos de la tabla sl_anulaciones_patrocinadores.
 *
 *
 *
 *
 ...
 */
   ...
   use backend\models\TiposPropaganda;
    ...
    class SlAnulacionesPatrocinadores extends ActiveRecord
    {
        ...
        {
          return 'sl_anulaciones_patrocinadores';
        }
