 ...
 */
 ...
 /**
 *  @file CalculoPorAlicuotaAplicadaAvaluo.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 10-01-2017
 *
 *  @class CalculoPorAlicuotaAplicadaAvaluo
 *  @brief Clase Modelo
 *
 *
 *  @property
		...
		private function calcularImpuesto($avaluo)
		{
			...
			if ( count($tarifa) > 0 ) {
				...
				if ( $montoAvaluo > 0 ) {
					...
					} elseif ( $tarifa[0]['monto_bs'] > 0 && $avaluo[0]['id_uso_inmueble'] == 4 ) {
						$monto = $tarifa[0]['monto_bs'] * $montoAvaluo * 12;
