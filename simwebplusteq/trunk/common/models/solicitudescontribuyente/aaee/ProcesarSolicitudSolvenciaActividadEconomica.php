 ...
 */
     ...
     */
    class ProcesarSolicitudSolvenciaActividadEconomica extends SolvenciaActividadEconomicaSearch
    {
        /**
         ...
         */
        public function findSolicitudSolvenciaActividad()
        {
        ...
        {
            $result = false;
            // modelo de SolvenciaActividadEconomica. Uno o varios registros.
            $modelSolvencia = self::findSolicitudSolvenciaActividad();
         ...
         * (SolvenciaActividadEconomica). Este modelo contiene los datos-detalles,
        ...
        private function createHistoricoSolvencia($modelSolvencia)
        {
            ...
            if ( isset($_SESSION['idContribuyente']) ) {
                ...
                $arregloDatos['observacion'] = 'SOLICITUD SOLVENCIA ' . $modelSolvencia[0]->observacion;
         ...
         * @param  SolvenciaActividadEconomica $modelSolvencia modelo con la consulta.
         * @return boolean retorna true si guarda satisfactoriamente.
         */
