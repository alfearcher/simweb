 ...
 */
 ...
 /**
 *  @file ProcesarSolicitudLicenciaRenovacion.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 22/11/2016
 *
 *  @class ProcesarSolicitudLicenciaRenovacion
 *  @brief
 *
 *
 *
 ...
 */
     ...
     */
    class ProcesarSolicitudLicenciaRenovacion extends LicenciaSolicitudSearch
    {
        /**
        ...
        private function createHistoricoLicencia($modelLicencia)
        {
            ...
            if ( isset($_SESSION['idContribuyente']) ) {
                ...
                $arregloDatos['observacion'] = 'SOLICITUD RENOVACION LICENCIA APROBADA POR FUNCIONARIO';
