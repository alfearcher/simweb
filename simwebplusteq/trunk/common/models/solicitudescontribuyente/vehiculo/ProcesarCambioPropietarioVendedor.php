 ...
 */
     ...
     */
    class ProcesarCambioPropietarioVendedor extends SlCambioPropietarioVehiculo
    {
         ...
         * en caso contrario.
         */
        public function findCambioPropietarioVehiculoVendedor()
        {
           // die('llegue al find cambio propietario');
            ...
            // la consulta.
            $SlCambiosPropietariosVendedor = New SlVehiculosForm($this->_model->id_contribuyente);

            $modelFind = $SlCambiosPropietariosVendedor->findSolicitudCambioPropietarioVendedor($this->_model->nro_solicitud);
        ...
        */
        ...
        private function aprobarDetalleSolicitud()
        {
           // die('llego a aprobar');
            $result = false;
            $modelInscripcion = self::findCambioPropietarioVehiculoVendedor();
            //die(var_dump($modelInscripcion));
            if ( $modelInscripcion !== null ) {
                if ( $modelInscripcion['id_propietario'] == $this->_model->id_contribuyente ) {
                    //die('comparo');
                    $result = self::updateSolicitudCambioPropietarioVendedor($modelInscripcion);
                    // if ( $result ) {
         ...
         * en caso contrario.
         */
        private function updateSolicitudCambioPropietarioVendedor($modelInscripcion)
        { 
