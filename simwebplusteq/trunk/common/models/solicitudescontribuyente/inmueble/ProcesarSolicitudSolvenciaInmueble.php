 ...
 */
 ...
 /**
 *  @file ProcesarSolicitudSolvenciaInmueble.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 22/11/2016
 *
 *  @class ProcesarSolicitudSolvenciaInmueble
 *  @brief
 *
 *
 *
 ...
 */
     ...
     */
    class ProcesarSolicitudSolvenciaInmueble extends SolvenciaInmuebleSearch
    {
        /**
         ...
         */
        public function findSolicitudSolvenciaInmueble()
        {
        ...
        {
            $result = false;
            // modelo de SolvenciaInmueble. Uno o varios registros.
            $modelSolvencia = self::findSolicitudSolvenciaInmueble();
         ...
         * (SolvenciaInmueble). Este modelo contiene los datos-detalles,
        ...
        private function createHistoricoSolvencia($modelSolvencia)
        {
            ...
            if ( isset($_SESSION['idContribuyente']) ) {
                ...
                $searchSolvencia = New SolvenciaInmuebleSearch($idContribuyente, $modelSolvencia[0]->id_impuesto);
                ...
                // Se obtiene los datos del inmueble
                $modelSearch = $searchSolvencia->findSolicitudSolvencia($modelSolvencia[0]->nro_solicitud);
                $modelSearch = $modelSearch->joinWith('inmueble V1', true, 'INNER JOIN')->one();
                $direccion = $modelSearch->inmueble->direccion;
                $catastro = 0;
                ...
                $arregloDatos['observacion'] = 'SOLICITUD SOLVENCIA INMUEBLE ' . $modelSolvencia[0]->observacion;
        ...
        private function createSolvencia($modelSolvencia)
        {
            ...
            if ( isset($_SESSION['idContribuyente']) ) {
                ...
                $searchSolvenciaActividad = New SolvenciaInmuebleSearch($idContribuyente, $modelSolvencia[0]->id_impuesto);
