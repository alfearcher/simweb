 ...
 */
 ...
 /**
 *  @file EnviarEmailNatural.php
 *
 *  @author Manuel Alejandro Zapata Canelon
 *
 *  @date 04/01/2016
 *
 *  @class EnviarEmailNatural
 *  @brief Modelo que contiene el metodo que se encarga de enviar el email al usuario automaticamente con su usuario, contraseña, nombre y apellido para que sea mas personalizado.
 *
 *
 *
 *
