...
<div class="col-sm-10">
		<div class="panel panel-primary">
			...
			<div class="row" style="margin-left: 10px;">
					...
					<?= Html::a('Cambiar Contraseña',['/usuario/cambiar-password-contribuyente/seleccionar-tipo-contribuyente'], ['class' => 'btn btn-primary']) //BOTON DE RECUPERAR CONTRASENA ?>
					<?= Html::a('Recuperar Contraseña',['/usuario/recuperar-password-contribuyente/seleccionar-tipo-contribuyente'], ['class' => 'btn btn-primary']) //BOTON DE RECUPERAR CONTRASENA ?>
              </div>
