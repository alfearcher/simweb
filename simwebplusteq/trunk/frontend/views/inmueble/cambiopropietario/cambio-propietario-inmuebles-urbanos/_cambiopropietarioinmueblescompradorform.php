...
if ($( "input:checked" ).val() == 1) { 
    ...
    if (document.getElementById("inmueblesurbanosform-cambio").value==1) { 
        document.getElementById("seller").style.display=''; 
        document.getElementById("buyer").style.display='none'; 
        
    } 

    if (document.getElementById("inmueblesurbanosform-cambio").value==2) { 
        document.getElementById("buyer").style.display='';
        document.getElementById("seller").style.display='none';
...
<?= $form->field($model, 'cambio')->hiddenInput(['id'=>'inmueblesurbanosform-cambio','value' => $cambio,'onchange' => 'bloquea()'])->label(false) ?>
