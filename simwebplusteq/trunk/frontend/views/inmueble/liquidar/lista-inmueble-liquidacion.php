 ...
 */
 ...
 /**
 *  @file lista-inmueble-liquidacion.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 21-11-2016
 *
 *  @view lista-inmueble-liquidacion.php
 *
 *
 *  @property
 *
...
<div class="lista-inmueble-liquidacion">
 	<?php

 		$form = ActiveForm::begin([
 			'id' => 'id-lista-inmueble-liquidacion-form',
 			'method' => 'post',
 			//'action' => $url,
        		...
        		<div class="col-sm-12">
					...
					<div class="row" style="width:100%;">
						...
						<div class="row" style="padding:0px;">
							...
							<div class="col-sm-2" style="width:40%;padding:0px;padding-left: 5px;">
								<h5><?=Html::encode('Direccion')?></h5>
							</div>
							<div class="col-sm-2" style="width:25%;padding:0px;padding-left: 10px;">
								<h5><?=Html::encode('Catastro')?></h5>
							</div>
								...
								<?php foreach ( $models as $i => $model ): ?>
									...
									<div class="row" style="padding: 0px;">
										...
										<div class="col-sm-2" style="width:25%;padding:0px;margin:0px;padding-left: 10px;margin-top:-10px;">
			                                <?= $form->field($model, "[{$i}]catastro")->textInput([
	                                														'readonly' => true,
	                                														'style' => 'width: 100%;background-color:white;'
			                                											])->label(false);
			                                ?>
