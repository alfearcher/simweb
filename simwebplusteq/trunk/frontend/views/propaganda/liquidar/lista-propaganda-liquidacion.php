 ...
 */
 ...
 /**
 *  @file lista-propaganda-liquidacion.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 21-11-2016
 *
 *  @view lista-propaganda-liquidacion.php
 *
 *
 *  @property
 *
...
<div class="lista-propaganda-liquidacion">
 	<?php

 		$form = ActiveForm::begin([
 			'id' => 'id-lista-propaganda-liquidacion-form',
 			'method' => 'post',
 			//'action' => $url,
        		...
        		<div class="col-sm-12">
					...
					<div class="row" style="width:100%;">
						...
						<div class="row" style="padding:0px;">
							...
							<div class="col-sm-2" style="width:25%;padding:0px;padding-left: 5px;">
								<h5><?=Html::encode('Nombre de la Propaganda')?></h5>
							</div>
							<div class="col-sm-2" style="width:40%;padding:0px;padding-left: 12px;">
								<h5><?=Html::encode('Direccion')?></h5>
							</div>
							<div class="col-sm-2" style="width:18%;padding:0px;margin:0px;padding-left:15px;">
							...
							<div class="container-items" style="padding-top: 10px;">
								<?php foreach ( $models as $i => $model ): ?>
									...
									<div class="row" style="padding: 0px;">
										...
										<div class="col-sm-2" style="width:25%;padding:0px;margin:0px;padding-left: 10px;margin-top:-10px;">
			                                <?= $form->field($model, "[{$i}]nombre_propaganda")->textInput([
	                                														'readonly' => true,
	                                														'style' => 'width: 100%;background-color:white;'
			                                											])->label(false);
			                                ?>
										...
										<div class="col-sm-2" style="width:40%;padding:0px;margin:0px;padding-left: 10px;margin-top:-10px;">
			                                <?= $form->field($model, "[{$i}]direccion")->textArea([
	                                														'readonly' => true,
	                                														'style' => 'width: 100%;background-color:white;',
	                                														'rows' => 2,
			                                											])->label(false);
