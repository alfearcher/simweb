 ...
 */
 ...
 /**
 *  @file desincorporar-ramo-form.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 02-09-2016
 *
 *  @view desincorporar-ramo-form.php
 *
 *
 *  @property
 *
 ...
 */
 ...
 <div class="desincorporar-ramo-form">
 	<?php

 		$form = ActiveForm::begin([
 			'id' => 'id-desincorporar-ramo-form',
 			'method' => 'post',
 			//'action' => $url,
					                		...
					                		<?= $form->field($model, 'ano_impositivo')->dropDownList($listaAño,[
	                																	 			...
	                																	 			'style' => 'width: 100%;',
	                                                                     				 			...
	                                                                     				 			'onchange' => '$.post( "' . Yii::$app->urlManager
                                                                                                                                         ->createUrl('/aaee/desincorporaramo/desincorporar-ramo/lista-periodo') . '&id=' . '" + $(this).val(),
                                                                                                                                         		 													function( data ) {
