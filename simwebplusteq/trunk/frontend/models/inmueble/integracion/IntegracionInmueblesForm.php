...
namespace frontend\models\inmueble\integracion;
...
class IntegracionInmueblesForm extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [ 
            ...
            [['id_contribuyente','id_impuesto','ano_inicio', 'validacion'], 'integer','message' => Yii::t('backend', 'only integers')],
            ...
            [['casa_edf_qta_dom','piso_nivel_no_dom','apto_dom', 'tipo_ejido',  'direccion'], 'required','message' => Yii::t('backend', 'Required field')],
