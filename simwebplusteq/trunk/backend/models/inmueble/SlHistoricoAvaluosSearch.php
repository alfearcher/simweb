 ...
 */
	...
	* 	Clase
	*/
	class SlInmueblesUrbanosSearch extends SlHistoricoAvaluosForm
	{
	     ...
	     */
	    public function findAvaluos($nroSolicitud)
	    {
	    	$modelFind = SlHistoricoAvaluosForm::find()->where('nro_solicitud =:nro_solicitud', [':nro_solicitud' => $nroSolicitud])
