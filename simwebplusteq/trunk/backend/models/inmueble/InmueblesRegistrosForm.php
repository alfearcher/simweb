...
class InmueblesRegistrosForm extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [ 
            ...
            //[['documento_propiedad'], 'integer','message' => Yii::t('backend', 'Debe seleccionar una opcion')],
           // [['documento_propiedad', 'fecha','num_reg','reg_mercantil' ], 'required','message' => Yii::t('backend', 'Campo requerido')],

            //[['nro_matriculado', 'asiento_registral'], 'required','message' => Yii::t('backend', 'Campo requerido'),'when'=> function($model){ return $this->documento_propiedad == 1; }],
            //[['tomo', 'protocolo','folio'], 'required','message' => Yii::t('backend', 'Campo requerido'),'when'=> function($model){ return $this->documento_propiedad == 2; }],
