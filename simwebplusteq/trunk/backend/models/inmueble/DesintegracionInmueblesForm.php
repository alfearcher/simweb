...
class DesintegracionInmueblesForm extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ano_inicio', 'ano_inicio1', 'manzana_limite',  'inactivo', 'id_habitante', 'tipo_ejido', 'tipo_ejido1'], 'integer','message' => Yii::t('backend', 'only integers')],
            ...
            [['casa_edf_qta_dom'], 'string', 'max' => 50,'message' => Yii::t('backend', 'Only 50 character')],
            ...
            //inmueble2
            [['ano_inicio1', 'manzana_limite',  'inactivo1', 'id_habitante1', 'tipo_ejido1'], 'integer','message' => Yii::t('backend', 'only integers')],
