 ...
 */
 ...
 /**
 *  @file CorreccionRepresentanteLegalSearch.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 08-08-2016
 *
 *  @class CorreccionRepresentanteLegalSearch
 *  @brief Clase Modelo
 *
 *
 *  @property
 ...
 */
	...
	class CorreccionRepresentanteLegalSearch
	{
		 ...
		 * de representante legal. El $findModel retorna sin valores y solo aplicando el ->all()
		 ...
		 */
		public function findSolicitudCorreccionRepresentanteLegal($nroSolicitud)
		{
			$findModel = CorreccionRepresentanteLegal::find()->where('nro_solicitud =:nro_solicitud',
		...
		{
			$modelFind = null;
			$modelFind = CorreccionRepresentanteLegal::find()->where('id_contribuyente =:id_contribuyente', [':id_contribuyente' => $this->_id_contribuyente])
		 ...
		 * de inscripcion de actividad economica pendiente.
		 * Esto aplica para los contribuyentes juridicos.
		 * @return boolean retorna un true si ya posee la solicitud de inscripcion de
		 * actividad economica pendiente, false en caso contrario
		 */
		public function poseeSolicitudInscripcionActividadEconomicaPendiente()
		{
			$result = false;
			$inscripcion = New InscripcionActividadEconomicaSearch($this->_id_contribuyente);
			$result = $inscripcion->poseeSolicitudPendiente();
			return $result;
		}
	    ...
	    {
	    	$query = self::findSolicitudCorreccionRepresentanteLegal($nroSolicitud);
