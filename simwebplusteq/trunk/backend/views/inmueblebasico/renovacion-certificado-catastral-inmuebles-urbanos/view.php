...
<div class="inmuebles-view">
    ...
    <p>
        <?= Html::a(Yii::t('backend', 'Renovacion de certificado catastral'), ['inmueblebasico/renovacion-certificado-catastral-inmuebles-urbanos/renovacion-certificado-catastral-inmuebles'], ['class' => 'btn btn-primary']) ?>
