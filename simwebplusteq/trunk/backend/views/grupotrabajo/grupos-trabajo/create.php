                            ...
                            <tr>
                                <td>
                                    <div>
                                        ...
                                        <?= $form->field( $model, 'descripcion' )->label( false )->textInput( [ 'inline' => true, 'style' => 'width:100%;text-transform:uppercase;' ] )?>	
                                    </div>  
                                </td> 
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        ...
                                        <?= Html::activeHiddenInput( $model, 'fecha', [ 'value' => $fecha ] )?>
                                        <?= Html::activeHiddenInput( $model, 'inactivo', [ 'value' => $inactivo ] )?>
