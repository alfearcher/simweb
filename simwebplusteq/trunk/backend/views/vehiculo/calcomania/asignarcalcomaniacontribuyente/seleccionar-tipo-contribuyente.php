        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" >
                     ...
                     <div class="col-sm-6"; style="margin-left:100px; ">
                            <?= Html::a('<strong><center><span class="glyphicon glyphicon-user" style="font-size:20px"> Persona Natural</span></center></strong>', ['/vehiculo/calcomania/asignarcalcomaniacontribuyente/asignar-calcomania-contribuyente/busqueda-natural']); ?>
                       </div>
                       </div>
