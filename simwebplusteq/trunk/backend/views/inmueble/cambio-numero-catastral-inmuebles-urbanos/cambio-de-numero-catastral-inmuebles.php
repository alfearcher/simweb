...
<div class="inmuebles-update">
    ...
    <?= $this->render('_cambiodenumerocatastralinmueblesform', [
        'model' => $model, 'disabled'=>$disabled, 'modelAvaluo' => $modelAvaluo, 'modelRegistro'=>$modelRegistro,'rutaAyuda' => $rutaAyuda,
    ]) ?>
