 ...
 */
 ...
 /**
 *  @file reporte-recaudacion-detallada-nota-debito.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 13-10-2017
 *
 *  @view reporte-recaudacion-detallada-nota-debito.php
 *  @brief vista que muestra el detalle de los registros por concepto de notas de debito
 * o cheques devuelto, monto negativos.
 *
 *
 *  @property
 *
...
?>
<div class="reporte-recaudacion-detallada-nota-debito">
	<?php
		$descripcionLapso = Yii::t('backend', 'Notas de debito');
	...
	<div class="row" style="width: 100%;margin-top:15px;">
		<div class="row" style="border-bottom: 1px solid #ccc;background-color:#F1F1F1;padding-left: 5px;padding-top: 0px;">
			<div class="col-sm-2" style="width: 80%;">
				<h4><strong><?=Html::encode($descripcionLapso)?></strong></h4>
			</div>
		</div>
		<div class="row" class=<?=Html::encode($model[0]['codigo']);?>></div>
		<div class="row" style="width:100%;padding:0px;margin:0px;">
			<?= GridView::widget([
				'id' => 'id-grid-recaudacion-detallada-nota-debito-reporte',
		...
		<div class="row" style="border-bottom: 1px solid #ccc;background-color:#F1F1F1;padding-left: 5px;margin-top: -20px;">
			<div class="col-sm-2" style="width: 60%;">
				<strong><?=Html::encode(Yii::t('backend', 'Total por: ') . $descripcionLapso)?></strong>
			</div>
