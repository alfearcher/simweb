 ...
 *  
 */
namespace backend\controllers\inmueblebasico;
...
use backend\models\inmueblebasico\AvaluoCatastralForm;
...
//                foreach($avaluos as $key => $value){
                ...
                $arrayDatos1 = [  'id_contribuyente' => $_SESSION['idContribuyente'],
                                  ...
                                  'impuesto' => 2,
                                  'id_impuesto' => $_SESSION['datosInmueble']['id_impuesto'],// $value['id_impuesto'],
                ...
                $valor = $modelAvaluo->valor_construccion * $modelAvaluo->metros_construccion + $modelAvaluo->valor_terreno*$modelAvaluo->metros_terreno;
                $ano_impositivo = explode('-', $modelAvaluo->fecha);
                $arrayDatos2 = [    'id_impuesto' => $_SESSION['datosInmueble']['id_impuesto'],// $value['id_impuesto'],
                                    ...
                                    'valor_por_mts2_terreno' => $modelAvaluo->valor_terreno,
                                    'valor' => $valor,
                                    'id_uso_inmueble' => $modelAvaluo->id_uso_inmueble,
                                    'tipo_inmueble' => $modelAvaluo->tipo_inmueble,
                                    'clase_inmueble' => $modelAvaluo->clase_inmueble,
                                    'id_tipologia_zona' => $modelAvaluo->id_tipologia_zona,
                                    'lindero_norte' => $modelAvaluo->lindero_norte,
                                    'lindero_sur' => $modelAvaluo->lindero_sur,
                                    'lindero_este' => $modelAvaluo->lindero_este,
                                    'lindero_oeste' => $modelAvaluo->lindero_oeste,
