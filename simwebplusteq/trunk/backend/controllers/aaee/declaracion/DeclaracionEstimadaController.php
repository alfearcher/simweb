 ...
 *	@brief Clase DeclaracionEstimadaController del lado del contribuyente backend.
 *
 *
 *	@property
 *
	...
	class DeclaracionEstimadaController extends Controller
	{
			...
			if ( isset($_SESSION['idContribuyente']) && isset($_SESSION['begin']) && isset($_SESSION['conf'])) {
				...
				if ( isset($postData['btn-back-form']) ) {
		  		...
		  		if ( isset($findModel) ) {
					...
					return $this->render('@frontend/views/aaee/declaracion/estimada/_create',
																[
																	'model' => $model,
																	'caption' => $caption,
    	...
    	private function actionShowSolicitud($findModel, $modelSearch, $dataProvider)
    	{
    		if ( isset($findModel) && isset($modelSearch) ) {
				...
				return $this->render('@frontend/views/aaee/declaracion/estimada/_view', [
																'codigo' => 100,
																'model' => $model,
