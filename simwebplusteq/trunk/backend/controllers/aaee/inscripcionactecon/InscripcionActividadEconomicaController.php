 ...
 *	@brief Clase InscripcionActividadEconomicaController, controlador del lado del backend
 *
 *
 *	@property
 *
 ...
 */
	...
	class InscripcionActividadEconomicaController extends Controller
	{
		...
		public function actionViewSolicitud()
		{
			...
			return $this->render('@frontend/views/aaee/inscripcion-actividad-economica/view-solicitud', [
