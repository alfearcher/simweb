 ...
 *	@brief Clase SolvenciaInmuebleGenerarController del lado del contribuyente backend.
 *
 *
 *	@property
 *
	...
	class SolvenciaInmuebleGenerarController extends Controller
	{
		...
		public function actionIndex()
		{
			...
			if ( $_SESSION['idContribuyente']) {
				...
				if ( isset($postData['id']) ) {
					if ( $idContribuyente == $postData['id_contribuyente'] ) {
						...
						if ( $model !== null ) {
							...
							return $this->render('@frontend/views/inmueble/solvencia/historico/historico-solvencia',[
																		'model' => $model,
				...
				if ( $provider !== null ) {
					return $this->render('@frontend/views/inmueble/solvencia/historico/listado-inmueble-existentes',[
