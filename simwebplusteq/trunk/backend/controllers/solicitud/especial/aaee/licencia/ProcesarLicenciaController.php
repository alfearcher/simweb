 ...
 */
 	...
 	namespace backend\controllers\solicitud\especial\aaee\licencia;
	 ...
	 */
	class ProcesarLicenciaController extends Controller
	{
		...
		public function actionMostrarListadoSeleccionado()
		{
			...
			if ( isset($postData['btn-confirmar-aprobar']) ) {
				...
				return $this->render('/solicitud/especial/aaee/licencia/pre-view-lista-seleccion-solicitud',[
														'model' => $model,
														'dataProvider' => $dataProvider,
				]);
			}
