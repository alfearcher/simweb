 ...
 */
 ...
 /**
 *  @file ProcesarCambioNumeroCatastralInmuebleUrbano.php
 *
 *  @author Alvaro Jose Fernandez ARcher
 *
 *  @date 08/08/2016
 *
 *  @class ProcesarCambioNumeroCatastralInmuebleUrbano
 *  @brief
 *
 *
 *
 ...
 */
     ...
     */
    class ProcesarCambioPropietarioCompradorInmuebleUrbano extends SlInmueblesUrbanosSearch
    {
        private $_model;
        ...
        */
        ...
        {
            $result = false;
            $modelCambioPropietarioC = self::findActualizacionInmuebleUrbano();
            if ( $modelCambioPropietarioC !== null ) {
                if ( $modelCambioPropietarioC['id_contribuyente'] == $this->_model->id_contribuyente ) {
                    $result = self::updateSolicitudCambioPopietarioComprador($modelCambioPropietarioC);
                    // if ( $result ) {
         ...
         * en caso contrario.
         */
        private function updateSolicitudCambioPopietarioComprador($modelNumeroCatastral)
        { 
            $result = false;
