 ...
 *	@brief Clase SolvenciaVehiculoGenerarController del lado del contribuyente backend.
 *
 *
 *	@property
 *
	...
	class SolvenciaVehiculoGenerarController extends Controller
	{
		...
		public function actionIndex()
		{
			...
			if ( $_SESSION['idContribuyente']) {
				...
				if ( isset($postData['id']) ) {
					if ( $idContribuyente == $postData['id_contribuyente'] ) {
						...
						if ( $model !== null ) {
							...
							return $this->render('@frontend/views/vehiculo/solvencia/historico/historico-solvencia',[
																		'model' => $model,
				...
				if ( $provider !== null ) {
					return $this->render('@frontend/views/vehiculo/solvencia/historico/listado-vehiculo-existentes',[
