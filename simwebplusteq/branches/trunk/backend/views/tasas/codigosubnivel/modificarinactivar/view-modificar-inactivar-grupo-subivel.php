...
<div class="row" style="width: 70%;">
    <div class="info-solicitud">
        <div class="row">
            <h3><?= Html::encode('Seleccione El Grupo Subnivel que desee Modificar o Eliminar') ?></h3>
                <?= GridView::widget([
             ...
             [
                    ...
                    'buttons' => [
                        'modificar' => function ($url, $model, $key) {
                                ...
                                return Html::a('<center><span class= "fa fa-pencil"></span></center>',['verificar-grupo-subnivel-modificar' ,'value' => $key]);
                    ...
                    'buttons' => [
                        'inactivar' => function ($url, $model, $key) {
                                ...
                                return Html::a('<center><span class= "fa fa-ban"></span></center>',['inactivar-grupo-subnivel', 'value' => $key]);
