...
<div class="inmuebles-view">
    ...
    <p>
        <?= Html::a(Yii::t('backend', 'Urban property integration'), ['inmueble/integracion/integracion-inmuebles-urbanos/integracion-inmuebles','id_impuesto' =>$model->id_impuesto  ], ['class' => 'btn btn-primary']) ?> 
