 ...
 *	@brief Clase CorreccionRepresentanteLegalController del lado del contribuyente frontend.
 *
 *
 *	@property
 *
 ...
 */
 	...
 	namespace frontend\controllers\aaee\correccionreplegal;
	...
	class CorreccionRepresentanteLegalController extends Controller
	{
    	...
    	private function actionShowSolicitud($findModel, $modelSearch, $dataProvider)
    	{
    		if ( isset($findModel) && isset($modelSearch) ) {
				...
				return $this->render('/aaee/correccion-representante-legal/_view', [
																'codigo' => 100,
																'model' => $model,
