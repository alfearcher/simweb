 ...
 *
 *  @class SlCambioPlaca
 *  @brief Modelo que instancia la conexion a la base de datos para buscar datos de la tabla sl_cambios_placa
 *
 *
 *
 *
