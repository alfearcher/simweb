...
<!-- TIPO -->
                                    <div class="col-sm-1" style="padding-right: 0px;padding-left: 28px;">
...
<!-- FIN DE EMAIL -->
 ...
 <!-- Boton para aplicar la actualizacion -->
                                    ...
                                    <div class="col-sm-3" >
                                            ...
                                            <?= Html::a('Return',['/usuario/recuperar-password-contribuyente/seleccionar-tipo-contribuyente'], ['class' => 'btn btn-primary','style' => 'height:30px;width:140px;margin-left:80px;' ]) //BOTON DE RECUPERAR CONTRASENA ?>
