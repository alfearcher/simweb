 ...
 */
 ...
 /**
 *  @file SlCambioPropietarioSearch.php
 *
 ...
 */
	...
	* 	Clase
	*/
	class SlCambioPropietarioSearch extends SlCambioPropietarioForm
	{
	    ...
	    {
	    	$modelFind = SlCambioPropietarioForm::find()->where('nro_solicitud =:nro_solicitud', [':nro_solicitud' => $nroSolicitud])
	    													  //->andWhere('id_contribuyente =:id_contribuyente', [':id_contribuyente' => $this->id_contribuyente])
	    													  ->one();
