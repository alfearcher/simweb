 ...
 *	@brief Clase CorreccionFechaInicioController del lado del contribuyente frontend.
 *
 *
 *	@property
 *
 ...
 */
 	...
 	namespace frontend\controllers\aaee\correccionfechainicio;
	...
	class CorreccionFechaInicioController extends Controller
	{
		      		...
		      		if ( $model->validate() ) {
	      				...
	      				if ( isset($postData['btn-create']) ) {
	      					if ( $postData['btn-create'] == 1 ) {
	      						...
	      						return $this->render('/aaee/correccion-fecha-inicio/pre-view-create', [
	      																	'model' => $model,
    	...
    	private function actionShowSolicitud($findModel, $modelSearch)
    	{
    		if ( isset($findModel) && isset($modelSearch) ) {
				...
				return $this->render('/aaee/correccion-fecha-inicio/_view', [
																'codigo' => 100,
																'model' => $findModel,
