...
namespace backend\controllers\propaganda\desincorporarpropaganda;
...
use backend\models\propaganda\desincorporarpropaganda\DesincorporarPropagandaForm;
...
//aqui iria el proceso de solicitud evento 
                ...
                break;
                    ...
                    $conn->close();
                      ...
                      $documentos = $DocumentosRequisito->Documentos();
                        $enviarNumeroSolicitud->plantillaEmailSolicitud($login['email'],$solicitud, $idSolicitud, $documentos);
