								 ...
								 <?= $form->field($model, 'impuesto')
								          ->dropDownList($listaImpuesto, [
                                                                  ...
                                                                  'onchange' => '$.post( "' . Yii::$app->urlManager
                                                                                       		           ->createUrl($rutaLista) . '&i=' . '" + $(this).val(), function( data ) {
...
<!-- Inicio Estatus de Solicitud -->
					<div class="row">
						<div class="col-sm-2">
							<div class="row">
								<p><strong><?= $model->getAttributeLabel('estatus_solicitud') ?></strong></p>
							</div>
						</div>
						<div class="col-sm-5">
							<div class="row" class="estatus-solicitud">
								 <?= $form->field($model, 'estatus_solicitud')
...
<!-- Fin de Estatus de Solicitud -->
					<div class="row" style="width: 100%;">
						<div class="col-sm-2" style="width: 100%;">
							<div class="row">
								<?= $form->field($model, 'ordenar_declaracion')->checkBox([
																				'id' => 'ordenar-declaracion',
																			])->label(false) ?>
							</div>
						</div>
					</div>
					...
					<!-- <div class="row" style="width: 100%;">
						<div class="col-sm-2" style="width: 100%;">
							<div class="row">
								<?//= $form->field($model, 'ordenar_liquidado')->checkBox([
								//												'id' => 'ordenar-liquidado',
								//											])->label(false) ?>
							</div>
						</div>
					</div>
