...
/* @var $form ActiveForm */
$this->title = Yii::t('backend', 'Change OF Ownership (BUYER)'). '<p>Id Tax: ' . $model->id_impuesto.'</p>';
 ?>
...
<div class="panel-heading">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-6">
                            <?= $form->field($datos, 'direccion')->textarea(
                                                                    [
                                                                    'readOnly'=>true,
                                                                    'id'=> 'direccion',
                                                                    ])->label(false);
...
<div class="panel panel-primary">
<div class="panel-heading">
                <?= Yii::t('frontend', 'Transation Specifications') ?> 
</div>
