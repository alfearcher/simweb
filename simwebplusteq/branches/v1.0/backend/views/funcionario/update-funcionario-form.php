 ...
 */
 ...
 /**
 *  @file update-funcionario-form.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 26-12-2016
 *
 *  @view update-funcionario-form
 *
 *
 *  @property
 *
...
<div class="update-funcionario">
 	<?php

 		$form = ActiveForm::begin([
 			'id' => 'id-update-funcinario',
 			'method' => 'post',
 			//'action' => ['index'],
    ...
    <div class="panel panel-primary"  style="width: 90%;">
		...
		<?= $form->field($model, 'id_funcionario')->hiddenInput(['value' => $model->id_funcionario])->label(false); ?>
        <?= $form->field($model, 'entes_ente')->hiddenInput(['value' => $model->entes_ente])->label(false); ?>
        ...
        <?= $form->field($model, 'id_departamento')->hiddenInput(['value' => $model->id_departamento])->label(false); ?>
        <?= $form->field($model, 'id_unidad')->hiddenInput(['value' => $model->id_unidad])->label(false); ?>
        <?= $form->field($model, 'niveles_nivel')->hiddenInput(['value' => $model->niveles_nivel])->label(false); ?>
        	...
        	<div class="container-fluid">
        		<div class="col-sm-12">
					...
					<div class="row" style="border-bottom: 1px solid #ccc;margin-top: 20px;;margin-bottom: 20px;">
							<h4><strong><?=Html::encode(Yii::t('backend', 'Modifique'))?></strong></h4>
						</div>
						...
						<div class="row" style="width: 100%;padding: 0px;padding-left: 15px;">
							...
							<div class="col-sm-4" style="padding: 0px;width: 45%;">
								...
								<div class="row" style="padding: 0px;">
									<div class="col-sm-2" style="width:85%;padding:0px;">
										<div class="unidad">
											<?= $form->field($model, 'id_unidad')->dropDownList($listaUnidad,[
																		 			'id' => 'unidad',
																		 			'style' => 'width: 100%;',
	                                                     				 			'prompt' => Yii::t('backend', 'Select..'),
	                                                            		])->label(false)
					...
					<div class="row" style="width: 100%;">
						<div class="col-sm-3" style="width: 30%;">
							<div class="form-group">
								<?= Html::submitButton(Yii::t('backend', 'Confirmar Guardar'),
																		  [
