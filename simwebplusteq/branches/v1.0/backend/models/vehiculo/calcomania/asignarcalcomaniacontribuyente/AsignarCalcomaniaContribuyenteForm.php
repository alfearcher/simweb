 ...
 */
 ...
 /**    
 *  @file AsignarCalcomaniaContribuyenteForm.php
 *  
 *  @author Manuel Alejandro Zapata Canelon
 * 
 *  @date 13/05/2016
 * 
 *  @class AsignarCalcomaniaContribuyenteForm.php
 *  @brief Clase contiene las rules y metodos para la busqueda de contribuyentes para luego asignarles la  calcomania
 *  para su vehiculo
 * 
 *  
 *  
...
class AsignarCalcomaniaContribuyenteForm extends Model
{
