 ...
 */
 ...
 /**
 *  @file PlanillaAporte.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 26-02-2017
 *
 *  @class PlanillaAporte
 *  @brief Clase Modelo
 *
 *
 *  @property
 ...
 */
	...
	/**
	* Clase principal de la entidad "planillas-aporte"
	*/
	class PlanillaAporte extends ActiveRecord
	{
		...
		/**
		 * Relacion con la entidad "depositos_detalle"
		 * @return [type] [description]
		 */
