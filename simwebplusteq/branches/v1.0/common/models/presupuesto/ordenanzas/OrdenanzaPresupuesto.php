 ...
 */
 ...
 /**
 *  @file OrdenanzaPresupuesto.php
 *
 *  @author Manuel Alejandro Zapata Canelon
 *
 *  @date 22/09/2016
 *
 *  @class OrdenanzaPresupuesto
 *  @brief Modelo que instancia la conexion a la base de datos para buscar datos de la tabla ordenanzas_presupuestos.
 *
 *
 *
 *
 ...
 */
    ...
    namespace common\models\presupuesto\ordenanzas;
    ...
    class OrdenanzaPresupuesto extends ActiveRecord
    {
        ...
        {
          return 'ordenanzas_presupuestos';
        }
