 ...
 */
    ...
    namespace common\models\presupuesto\cargarpresupuesto;
    ...
    class PresupuestosDetalle extends ActiveRecord
    {
        ...
        public function getCodigoPresupuesto()
        {
          ...
          public function getOrdenanzaPresupuesto()
        {
            return $this->hasOne(OrdenanzaPresupuesto::className(), ['id_presupuesto' => 'id_presupuesto']);
        }
