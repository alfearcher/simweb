 ...
 */
     ...
     */
    class ProcesarCambioDatosPropaganda extends SlPropagandas
    {
         ...
         * sobre la entidad "sl-propagandas", referente al detalle de la solicitud. Es la
         * entidad donde se guardan los detalle de esta solicitud.
         * @return Boolean Retorna un true si todo se ejecuto satisfactoriamente, false
         * en caso contrario.
         */
        public function findCambioDatosPropaganda()
        {
            ...
            $modelFind = $SlPropagandas->findCambioDatosPropaganda($this->_model->nro_solicitud);
        ...
        */
        ...
        private function aprobarDetalleSolicitud()
        {
           // die('llego a aprobar');
            $result = false;
            $modelCambioDatos = self::findCambioDatosPropaganda();
