 ...
 */
	...
	use backend\models\solicitud\especial\aaee\licencia\BusquedaSolicitudCertificadoForm;
 ...
 <div class="listado-solicitud-licencia">
    ...
    <div class="panel panel-primary"  style="width: 100%;">
        <div class="panel-heading">
        	<h3><?= Html::encode(Yii::t('frontend', 'Listado de Solicitudes de Certificado Catastrales')) ?></h3>
        </div>
        			...
        			<div class="row">
        				<div class="list-group">
        					...
        					<p class="list-group-item-text">
        						<?= Html::tag('li', Yii::t('backend', 'El listado corresponde a las solicitudes de EMISION DE CERTIFICADOS CATASTRALES (Nuevas y/o Renovadas).')); ?>
        						...
        						para su aprobación.')); ?>
        						<?= Html::tag('li', Yii::t('backend', 'Una vez aprobada la solicitud el Contribuyente podrá descargar su Certificado Catastral a través
        						de la opción <strong>Solicitudes/Inmuebles/Certificado Catastral/selecciona el inmueble correspondiente/Descargar Certificado Catastral.</strong>')); ?>
