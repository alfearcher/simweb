 ...
 */
 ...
 /**
 *  @file CorreccionCapital.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 02-08-2016
 *
 *  @class CorreccionCapital
 ...
 */
	 ...
	 */
	class CorreccionCapitalSearch extends CorreccionCapital
	{
		 ...
		 */
		public function findSolicitudCorreccionCapital($nroSolicitud)
		{
			$findModel = CorreccionCapital::find()->where('nro_solicitud =:nro_solicitud',
		...
		{
			$modelFind = null;
			$modelFind = CorreccionCapital::find()->where('id_contribuyente =:id_contribuyente',
