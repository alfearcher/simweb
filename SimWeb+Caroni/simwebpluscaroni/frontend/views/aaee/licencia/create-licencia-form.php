        	...
        	<div class="container-fluid">
        		<div class="col-sm-12">
					...
					<div class="row" style="width: 100%;padding: 0px;margin-top: 20px;">
							<div class="col-sm-3" style="width: 20%;padding: 0px;padding-left: 15px;">
							...
							<div class="col-sm-3" style="width: 20%;padding: 0px;padding-left: 25px;margin-left:30px;">
								<div class="form-group">
							...
							<div class="col-sm-2" style="width: 15%;margin-left: 50px;">
								<div class="form-group">
