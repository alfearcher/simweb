 ...
 */
 ...
 /**
 *  @file lista-propaganda.php
 *
 *  @author Jose Rafael Perez Teran
 *
 *  @date 21-11-2016
 *
 *  @view lista-propaganda.php
 *
 *
 *  @property
 *
...
<div class="lista-propaganda-activo">
 	<?php

 		$form = ActiveForm::begin([
 			'id' => 'id-lista-propaganda-form',
 			'method' => 'post',
 			'action' => $url,
        	...
        	<div class="container-fluid">
        		<div class="col-sm-12">
					...
					<div class="row" style="width:100%;">
						...
						<div class="row" id="id-lista-propaganda" style="padding: 0px;">
							<?= GridView::widget([
								'id' => 'id-grid-lista-propaganda',
								...
								'columns' => [
				                    ...
				                    [
				                        ...
				                        'label' => Yii::t('frontend', 'Nombre de la Propaganda'),
				                        'value' => function($data) {
